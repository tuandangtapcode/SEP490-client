...
//       toast.error("Đã xảy ra lỗi khi tải chi tiết blog.");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     { title: 'Môn học',align: "center", }, 
//     { title: 'Ngày đăng',align: "center", dataIndex: 'createdAt', key: 'createdAt', render: date => moment(date).format('DD/MM/YYYY') }, 
//     { title: 'Trạng thái',align: "center", }, 
//     { title: 'Giáo viên nhận',align: "center", }, 
...
//     )}
//     <Modal
//         visible={detailBlogModal}
//         title="Chi tiết bài viết"
//         onCancel={() => setDetailBlogModal(false)}
//         footer={null}
//       >
//         {loading ? (
//           <Spin />
...
//               </p>
//               <p>
//                 <strong>Mô tả:</strong> {selectedBlog.Content}
//               </p>
//               <p>
//                 <strong>Môn học:</strong> {selectedBlog.SubjectName}
//               </p>
//               <p>
...
//               </p>
//               <p>
//                 <strong>Giáo viên nhận:</strong> {selectedBlog.TeacherName || "Chưa có"}
//               </p>
//             </div>
//           )
//         )}
...
const BlogPosting = () => {
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      try {
        const res = await SubjectService.getListSubjects();
        if (!!res?.isError) return toast.error(res?.msg);
  ...
  console.log(`Blog ${blog.Title} - SubjectID: ${subjectId} - SubjectName: ${subjectName}`);
        return {
          ...blog,
          index: index + 1,
          SubjectName: subjectName || "Không xác định",
        };
      });
